...
import { KiroIcon } from "@/components/ui/kiro-icon";
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-7xl">
        <div className="text-center space-y-6">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            Free, open-source Pomodoro timer to boost your productivity and
            focus.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-muted-foreground text-center sm:text-left">
              <span className="flex items-center gap-1">
                Made with <KiroIcon className="w-4 h-5 text-white" /> Kiro and{" "}
                <Heart className="w-4 h-5 text-red-500" />
              </span>
            </div>
