    ...
    <div className="space-y-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <p>
          ...
          visit, which can make your next visit easier and the site more useful
          to you.
        </p>
        ...
        <ul>
          <li>
            <strong>Authentication cookies</strong> - To keep you logged in when
            you create an account
          </li>
          <li>
            <strong>Session storage</strong> - To maintain your timer state
            during your session
          </li>
          <li>
            <strong>Local storage</strong> - To save your tasks, settings, and
        ...
        <ul>
          <li>
            <strong>User preferences</strong> - Your timer settings, theme
            preferences, and audio choices
          </li>
          <li>
            <strong>Task data</strong> - Your tasks, categories, and progress
            tracking
          </li>
          <li>
            <strong>Statistics</strong> - Your productivity statistics and
            session history
          </li>
          <li>
            <strong>Break reminders</strong> - Your custom break reminder
            settings and completion history
          </li>
        </ul>

        <h2>Third-Party Services</h2>
        <p>
          PomoUno uses Firebase (Google) for authentication and data
          synchronization when you create an account. Firebase may set its own
          cookies for authentication purposes. You can learn more about
        ...
        <p>
          PomoUno does not use any analytics cookies, tracking pixels, or
          third-party advertising networks. We do not track your behavior across
          other websites.
        </p>
        ...
        <p>
          ...
          or uninstall your browser. If you create an account, your data is also
          stored on our secure servers and you can delete it at any time through
