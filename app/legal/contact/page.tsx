...
import { Mail, Github, MessageCircle, Bug, Lightbulb, Heart } from 'lucide-react';

export const metadata = {
    title: 'Contact Us',
    description: 'Get in touch with the PomoUno team - support, feedback, and contributions.',
};
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="rounded-xl p-6 space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        Need help with PomoUno? Have a question about features or your account?
                    </p>
                    <a
                ...
                <div className="rounded-xl p-6 space-y-4">
                    ...
                    <a
                        href="https://github.com/pomouno/pomouno/issues"
                        target="_blank"
                ...
                <div className="rounded-xl p-6 space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        Have an idea for a new feature? Share your suggestions with our community.
                    </p>
                    <a
                        href="https://github.com/pomouno/pomouno/discussions"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <div className="rounded-xl p-6 space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        Join our community discussions, share tips, and connect with other users.
                    </p>
                    <a
                        href="https://github.com/pomouno/pomouno/discussions"
                        target="_blank"
            ...
            <div className="rounded-xl p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                    PomoUno is completely open source! We welcome contributions from developers, designers,
                    and anyone who wants to help make productivity tools better for everyone.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a
                        href="https://github.com/pomouno/pomouno/blob/main/CONTRIBUTING.md"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors"
                    >
            ...
            <div className="rounded-xl p-6 text-center">
                ...
                <p className="text-muted-foreground">
                    ...
                    For urgent issues, please use GitHub issues for faster community support.
                </p>
            </div>
