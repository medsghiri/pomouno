...
export function ThemeProvider({ children }: ThemeProviderProps) {
    ...
    useEffect(() => {
        ...
        window.addEventListener('settingsUpdated', handleThemeChange as EventListener);

        return () => {
            window.removeEventListener('settingsUpdated', handleThemeChange as EventListener);
        };
    }, []);
