...
import { User, Trash2, Download, RotateCcw, Shield, AlertTriangle, ArrowLeft } from 'lucide-react';
import { updateProfile, deleteUser, updatePassword, EmailAuthProvider, reauthenticateWithCredential } from 'firebase/auth';
...
export function AccountManagement() {
    ...
    if (!user) {
        return (
            <div className="flex items-center justify-center p-8">
                <div className="text-muted-foreground">Please log in to manage your account.</div>
            </div>
        );
    }
    ...
    const handleExportData = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `pomouno-data-${new Date().toISOString().split('T')[0]}.json`;
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        This will permanently delete all your sessions, tasks, statistics, and settings.
                                        Your account will remain active but all progress will be lost. This action cannot be undone.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
