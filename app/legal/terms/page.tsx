...
export const metadata = {
  ...
  description:
    "PomoUno Terms of Service - Rules and guidelines for using our service.",
};
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <p>
          By accessing and using PomoUno, you accept and agree to be bound by
          the terms and provision of this agreement.
        </p>

        <h2>Description of Service</h2>
        <p>
          PomoUno is a free, open-source Pomodoro timer application designed to
          help users improve their productivity and focus through time
        ...
        <p>
          PomoUno is open-source software released under the MIT License. You
        ...
        <p>
          ...
          the service will be available at all times. We may temporarily suspend
          the service for maintenance or updates.
        </p>

        <h2>Limitation of Liability</h2>
        <p>
          PomoUno is provided &ldquo;as is&rdquo; without warranties of any
        ...
        <h2>User Content</h2>
        <p>
          You retain ownership of any content you create using PomoUno (tasks,
          notes, etc.). You grant us a limited license to store and sync this
