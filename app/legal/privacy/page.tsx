    ...
    <main className="space-y-8" role="main" aria-labelledby="privacy-heading">
      ...
      <article className="prose prose-gray dark:prose-invert max-w-none">
        <section aria-labelledby="introduction-heading">
          ...
          <p>
            At PomoUno, we believe your privacy is fundamental. This Privacy
            Policy explains how we collect, use, and protect your information
            when you use our Pomodoro timer application.
          </p>
        </section>
        ...
        <section aria-labelledby="collection-heading">
          ...
          <ul>
            ...
            <li>
              <strong>Display name</strong> - Optional, for personalization
            </li>
            <li>
              <strong>Tasks and productivity data</strong> - Your tasks, session
              history, and settings
            </li>
            <li>
              <strong>Break reminders</strong> - Your custom break reminder
              preferences
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Device information</strong> - Browser type and version for
              compatibility
            </li>
            <li>
              <strong>Usage data</strong> - Session timestamps and duration
              (stored locally first)
            </li>
            <li>
              <strong>Error logs</strong> - Technical errors to improve the
              service
            </li>
          </ul>
        ...
        <section aria-labelledby="usage-heading">
          ...
          <ul>
            <li>
              <strong>Provide the service</strong> - Timer functionality, task
              management, and statistics
            </li>
            <li>
              <strong>Sync your data</strong> - Across your devices when
              you&apos;re signed in
            </li>
            <li>
              <strong>Improve the app</strong> - Fix bugs and add features based
              on usage patterns
            </li>
            <li>
        ...
        <section aria-labelledby="storage-heading">
          ...
          <p>
            PomoUno is designed with a &ldquo;local-first&rdquo; philosophy.
            Your data is primarily stored on your device using browser local
            storage. This means:
          </p>
          <ul>
            <li>
              Your data remains on your device even if our servers are down
            </li>
          ...
          <p>
            When you create an account, we securely store a copy of your data
            using Firebase (Google Cloud Platform) to:
          </p>
          <ul>
          ...
          <ul>
            ...
            <li>
              <strong>Access controls</strong> - Only you can access your data
            </li>
            <li>
              <strong>Regular updates</strong> - We keep our security measures
              current
            </li>
          </ul>
        </section>
        ...
        <section aria-labelledby="sharing-heading">
          ...
          <p>
            ...
            parties. We only share data in these limited circumstances:
          </p>
          <ul>
            <li>
              <strong>Firebase/Google</strong> - For authentication and data
              storage (covered by Google&apos;s privacy policy)
            </li>
            <li>
            ...
            <li>
              <strong>Service providers</strong> - Only if necessary for core
              functionality, under strict privacy agreements
            </li>
          </ul>
        </section>
        ...
        <section aria-labelledby="rights-heading">
          ...
          <ul>
            <li>
              <strong>Access</strong> - View all your stored data anytime
            </li>
            <li>
              <strong>Update</strong> - Modify your information and settings
            </li>
            <li>
              <strong>Export</strong> - Download your data in a portable format
            </li>
            <li>
              <strong>Delete</strong> - Permanently remove your account and all
              data
            </li>
          </ul>
          ...
          <p>
            Your data is stored in standard formats and can be exported at any
            time. Since PomoUno is open-source, you can even run your own
            instance if desired.
          </p>
        </section>
        ...
        <section aria-labelledby="cookies-heading">
          ...
          <p>
            We use minimal cookies and primarily rely on browser local storage.
            See our{" "}
            <Link
              href="/legal/cookies"
        ...
        <section aria-labelledby="children-heading">
          ...
          <p>
            PomoUno is suitable for users of all ages, including students. We do
        ...
        <section aria-labelledby="international-heading">
          ...
          <p>
            PomoUno is available worldwide. Your data may be stored and
            processed in the United States or other countries where our service
        ...
        <section aria-labelledby="changes-heading">
          ...
          <p>
            PomoUno is completely open source. You can review our code, data
            handling practices, and privacy implementations at{" "}
            <a
        ...
        <section aria-labelledby="contact-heading">
          ...
          <ul>
            ...
            <li>
              GitHub Issues:{" "}
              <a
                href="https://github.com/medsghiri/pomouno/issues"
                target="_blank"
                rel="noopener noreferrer"
                className="text-red-600 dark:text-red-400 hover:underline"
              >
          ...
          <p>
            For privacy-related inquiries, you can reach our Data Protection
            Officer at: dpo@pomouno.com
          </p>
        </section>
      </article>
